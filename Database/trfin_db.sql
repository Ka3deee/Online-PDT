...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2024 at 08:12 AM
...
WHERE table_schema = 'trfin_db' and TABLE_NAME NOT IN ('users','stores','received_batch_trf_tbl','iupc_tbl','batchtransfer_tbl','batchtransfer_status_tbl','batchtransfer_download_logs_tbl','mtrdata_tbl');
...
--
-- Table structure for table `mtrdata_tbl`
--

CREATE TABLE `mtrdata_tbl` (
  `id` int(11) NOT NULL,
  `mtr_no` varchar(20) NOT NULL,
  `plate_no` varchar(20) NOT NULL,
  `delivery_date` datetime NOT NULL,
  `prepared_by` varchar(255) NOT NULL,
  `warehouse` decimal(5,0) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `transfer_no` varchar(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `mtrdata_tbl`
--
ALTER TABLE `mtrdata_tbl`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `mtrdata_tbl`
--
ALTER TABLE `mtrdata_tbl`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
