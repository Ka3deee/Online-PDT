      ...
      function order_qty(po){
        ...
        var xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "opt/mysqlpost.php?order_po="+po);
          xhttp.send();
      }
      function rec_qty(po){
        var resultjson = [];
        var xhttp = new XMLHttpRequest();
          xhttp.onload = function() {
            if(this.responseText == "No-Data"){
              ...
              document.getElementById('txtvar_li').value = parseFloat(document.getElementById('txtorder_li').value) - parseFloat(rec_li);
              document.getElementById('txtlvar_qty').value = parseFloat(document.getElementById('txtorder_qty').value) - parseFloat(rec_li);
              
            }			
          }
          xhttp.open("GET", "opt/mysqlpost.php?rec_qty="+po);
          xhttp.send();
      }
      ...
      function Get_sku(sku,poref){
          ...
          xhttp.open("GET", "opt/mysqlpost.php?getdesc="+sku+"&desc_po="+poref,false);
          xhttp.send();
      }
