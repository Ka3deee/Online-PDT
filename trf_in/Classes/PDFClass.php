...
function Footer()
{
    ...
    $this->Cell(16.4875,7,number_format($this->page_shpqty,2),1,0,'R');
    $this->Cell(16.4875,7,number_format($this->page_bum,2),1,0,'R');
    $this->Cell(16.4875,7,number_format($this->page_expqty,2),1,0,'R');
    $this->Cell(16.4875,7,number_format($this->page_rcvqty,2),1,0,'R');
    $this->Cell(16.4875,7,number_format($this->page_shtqty,2),1,1,'R');
...
function ImprovedTable($header, $data)
{
    ...
    foreach($data as $row)
    {
        ...
        $this->grand_shpqty += $row[3];
        $this->grand_bum += $row[4];
        $this->grand_expqty += $row[5];
        $this->grand_rcvqty += $row[6];
        $this->grand_shtqty += $row[7];


        $this->page_shpqty += $row[3];
        $this->page_bum += $row[4];
        $this->page_expqty += $row[5];
        $this->page_rcvqty += $row[6];
        $this->page_shtqty += $row[7];
