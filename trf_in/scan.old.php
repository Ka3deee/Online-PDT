...
<body>
    <div class="container">
        ...
        <table id="table" class="table table-bordered">
            <tr>
                <td>SKU:<div id="sku"></div></td>
                <td>TRF#:<div id="trf"></div></td>
            </tr>
            <tr>
                <td colspan = "2">DESC:<div id="desc"></div></td>
            </tr>
            <tr>
                <td>EXPQTY:<input id="expqty" type="text" value="0.00" style="width:100%" readonly/></td>
                <td>RCVQTY:<input id="rcvqty" type="text" value="0.00" style="width:100%"/></td>
            </tr>
        </table>
...
document.getElementById("save").addEventListener('click', function() {
        ...
        if(1 == 2){
            ...
            xmlhttp.open("GET","fx/savescanned.fx.php?trfbchid="+trfbch_id+"&&rcvqty="+rcvqty+"&&oldqty="+oldqty+"&&expqty="+expqty,true);
            xmlhttp.send();
        }
    });
