...
<div class="container text-center">
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <input  maxlength="5" size="5" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" value = "<?php if(isset($_SESSION['Storecode']) ){ echo $_SESSION['Storecode']; } ?>"style = "text-align:center !important;"  class="form-control input-lg" name="txtstorecode"  id="txtstorecode" type="text" autofocus >			
      <?php if (isset($_SESSION['Storecode']) ) { ?>
        <div id = "promptalert" style = "font-size:1em;" class="alert alert-success alert-dismissible fade in">
          <strong></strong><b ><?php echo $_SESSION['Storecode_loc'];?></b>
        </div>
      <?php } ?>
  ...
  <br>
	<div>
		<button type="button" class="btn btn-primary btn-lg btn-block" onclick = "Checkstore()" id = "btnsetstore" name = "btnsetstore"><span class="glyphicon glyphicon-ok"></span> Save</button>
